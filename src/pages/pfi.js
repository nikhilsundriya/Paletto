...
export default function Pfi() {
  ...
  return (
    <div className="flex justify-center">
      <Head>
        <title>Paletto : Palette from Image [AI]</title>
        <meta name="title" content="Paletto : Palette from Image [AI]" />
        <meta
          name="description"
          content="Paletto's Palette from Image [AI] feature allows you to generate a color palette from an image or logo. This feature uses artificial intelligence to analyze the colors in the image and create a palette that complements it. This feature is particularly useful for branding projects or when you need to match colors from an existing design."
        />

        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://paletto.itsvg.in/pfi" />
        <meta property="og:title" content="Paletto : Palette from Image [AI]" />
        <meta
        ...
        <meta
          property="og:image"
          content="https://paletto.itsvg.in/assets/5.png"
        />
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://paletto.itsvg.in/pfi" />
        <meta
          property="twitter:title"
          content="Paletto : Palette from Image [AI]"
        />
        <meta
