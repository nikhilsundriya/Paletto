...
export default function Trending() {
  ...
  return (
    <>
      <Head>
        <title>Paletto : Trending Palettes 🔥</title>
        <meta name="title" content="Paletto : Trending Palettes 🔥" />
        <meta
          name="description"
          content="Paletto's Trending Color Palettes feature allows you to stay on top of the latest color trends. Whether you're designing a website, creating a marketing campaign, or designing a product, this feature can help you select the most popular colors for your project. You can also customize the palettes to your liking with Paletto's user-friendly interface."
        />

        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://paletto.itsvg.in/trending" />
        <meta property="og:title" content="Paletto : Trending Palettes 🔥" />
        <meta
        ...
        <meta
          property="og:image"
          content="https://paletto.itsvg.in/assets/2.png"
        />
        <meta property="twitter:card" content="summary_large_image" />
        <meta
          property="twitter:url"
          content="https://paletto.itsvg.in/trending"
        />
        <meta
          property="twitter:title"
          content="Paletto : Trending Palettes 🔥"
        />
        <meta
