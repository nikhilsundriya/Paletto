...
export default function ColorSays() {
  return (
    <>
      <Head>
        <title>Paletto : What Color Says</title>
        <meta name="title" content="Paletto : What Color Says" />
        <meta
          name="description"
          content="Paletto's What Color Says! feature allows you to understand the significance of a color and decide which color suits you the best. This feature provides insights into the psychology of color and how different colors can affect emotions and behavior. This feature is useful when you want to create a design that resonates with your target audience."
        />

        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://paletto.itsvg.in/color-says" />
        <meta property="og:title" content="Paletto : What Color Says" />
        <meta
        ...
        <meta
          property="og:image"
          content="https://paletto.itsvg.in/assets/7.png"
        />
        <meta property="twitter:card" content="summary_large_image" />
        <meta
          property="twitter:url"
          content="https://paletto.itsvg.in/color-says"
        />
        <meta property="twitter:title" content="Paletto : What Color Says" />
        <meta
