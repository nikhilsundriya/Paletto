...
export default function Gradients() {
  ...
  return (
    <>
      <Head>
        <title>Paletto : Awesome Gradients ✨</title>
        <meta name="title" content="Paletto : Awesome Gradients ✨" />
        <meta
          name="description"
          content="Paletto's Awesome Gradients feature allows you to generate infinite gradients with ease. Gradients can add depth and texture to your designs and make them more visually appealing. With this feature, you can experiment with different color combinations and create gradients that suit your design needs.
"
        />

        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://paletto.itsvg.in/gradients" />
        <meta property="og:title" content="Paletto : Awesome Gradients ✨" />
        <meta
...
"
        ...
        <meta
          property="og:image"
          content="https://paletto.itsvg.in/assets/3.png"
        />
        <meta property="twitter:card" content="summary_large_image" />
        <meta
          property="twitter:url"
          content="https://paletto.itsvg.in/gradients"
        />
        <meta
          property="twitter:title"
          content="Paletto : Awesome Gradients ✨"
        />
        <meta
